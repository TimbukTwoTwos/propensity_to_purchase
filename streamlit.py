...
thirtyDayOrderCount = st.number_input('Total Order Counnt:', min_value=0.1, max_value=100.0, value=1.0)
ninetyDayOrderCount = st.number_input('Total Order Counnt:', min_value=0.1, max_value=100.0, value=1.0)
oneEightyDayOrderCount = st.number_input('Total Order Counnt:', min_value=0.1, max_value=100.0, value=1.0)
ThreeSixFiveDayOrderCount = st.number_input('Total Order Counnt:', min_value=0.1, max_value=100.0, value=1.0)
